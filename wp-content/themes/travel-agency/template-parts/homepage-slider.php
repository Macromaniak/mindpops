<section class="homeslider_section wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp;">
	...
	<div class="container">
      ...
      $desti_block_underline = get_field('destination_slider_block_underline_image');

      if(!empty($slider_title)){

      ?>

      <h2 class="section-title <?php echo $desti_block_underline ? 'no-bottom-padding' : 'ul-green' ?>"><?php echo $slider_title ?></h2>

  	<?php } 

    if($desti_block_underline){
        	...
        	<div class="item">
        		...
        		<div class="slider-bx-s">
        			...
        			<a href="<?php echo get_term_link($parent_lists->term_id); ?>">
	    				...
	    				<img src="<?php echo $cat_img['sizes']['desti-slider-thumb'] ?>">
