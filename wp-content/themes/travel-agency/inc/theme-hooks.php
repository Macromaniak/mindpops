...
function new_themes_styles() {
    ...
    wp_enqueue_style( 'style_css2', get_stylesheet_directory_uri() . '/css/owl.carousel.min.css' );
...
add_action( 'wp_enqueue_scripts', 'new_themes_styles' );
 ...
 function new_themes_js() {
    ...
    wp_enqueue_script( 'js-owl', get_stylesheet_directory_uri() . '/js/owl.carousel.min.js', '', '', true );
    wp_enqueue_script( 'js-custom', get_stylesheet_directory_uri() . '/js/custom.js', '', '', true );
}
