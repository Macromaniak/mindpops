...
<section class="our-deals" id="deal_section">
   ...
   <div class="tabs">
      ...
      <div class="container offer-page-title-section">

      <?php 
      $title = get_field('titile');
      ...
      <header class="section-header wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s" 
         ...
         <?php if(!empty($title)){ ?><h2 class="section-title <?php echo $title_underline_image ? 'no-bottom-padding' : 'ul-green' ?>"><?php echo $title; ?></h2> <?php } 
